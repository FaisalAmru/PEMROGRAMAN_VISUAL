...
class TrapesiumGUI:
    ...
    def aturKomponen(self):
        ...
        Label(main_frame, text='Masukan Panjang Sisi Atas:').grid(
            row=0, column=0, sticky=W, padx=5, pady=5)
        Label(main_frame, text="Masukan Panjang Sisi Bawah:").grid(
            row=1, column=0, sticky=W, padx=5, pady=5)
        Label(main_frame, text="Masukan Tinggi Trapesium:").grid(
            row=2, column=0, sticky=W, padx=5, pady=5)
        Label(main_frame, text="Luas Trapesium:").grid(
        ...
        self.btnHitung = Button(
            main_frame, text='Hitung', command=self.onHitung)
