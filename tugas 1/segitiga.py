...
class FrmSegitiga:
    ...
    def aturKomponen(self):
        ...
        Label(main_frame, text='Masukan Alas:').grid(
            row=0, column=0, sticky=W, padx=5, pady=5)
        Label(main_frame, text="Masukan Tinggi:").grid(
            row=1, column=0, sticky=W, padx=5, pady=5)
        Label(main_frame, text="Luas Segitiga:").grid(
        ...
        self.btnHitung = Button(
            main_frame, text='Hitung', command=self.on_hitung)
