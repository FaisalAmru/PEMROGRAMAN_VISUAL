...
class PersegiPanjang:
    ...
    def aturKomponen(self):
        ...
        Label(mainFrame, text='Masukan Panjang:').grid(
            row=0, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Masukan Lebar:").grid(
            row=1, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Luas Persegi Panjang:").grid(
            row=3, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Keliling Persegi Panjang:").grid(
        ...
        self.btnHitung = Button(
            mainFrame, text='Hitung', command=self.onHitung)
...
if __name__ == '__main__':
    root = Tk()
    aplikasi = PersegiPanjang(
        root, "Program Luas dan Keliling Persegi Panjang")
    root.mainloop()
