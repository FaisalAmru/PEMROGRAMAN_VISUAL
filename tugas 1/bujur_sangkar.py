...
class Persegi(Frame):
    ...
    def aturKomponen(self):
        ...
        Label(main_frame, text='Masukan Panjang Sisi:').grid(
            row=0, column=0, sticky=W, padx=5, pady=5)
        Label(main_frame, text="Luas Persegi atau Bujur Sangkar:").grid(
            row=2, column=0, sticky=W, padx=5, pady=5)
        Label(main_frame, text="Keliling Persegi atau Bujur Sangkar:").grid(
...
if __name__ == '__main__':
    root = Tk()
    aplikasi = Persegi(
        root, "Program Luas dan Keliling Persegi atau Bujur Sangkar")
    root.mainloop()
