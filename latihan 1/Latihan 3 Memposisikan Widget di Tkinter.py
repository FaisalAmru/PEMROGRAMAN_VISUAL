...
class FormBlanko:
    ...
    def aturKomponen(self):
        ...
        Label(mainFrame, text='A1').grid(
            row=0, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text='B1').grid(
            row=0, column=1, sticky=W, padx=5, pady=5)
        Label(mainFrame, text='C1').grid(
            row=0, column=2, sticky=W, padx=5, pady=5)
        Label(mainFrame, text='D1').grid(
            row=0, column=3, sticky=W, padx=5, pady=5)
        Label(mainFrame, text='E1').grid(
            row=0, column=4, sticky=W, padx=5, pady=5)
        Label(mainFrame, text='F1').grid(
            row=0, column=5, sticky=W, padx=5, pady=5)
        Label(mainFrame, text='A2').grid(
            row=1, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text='B2').grid(
            row=1, column=1, sticky=W, padx=5, pady=5)
        Label(mainFrame, text='C2').grid(
            row=1, column=2, sticky=W, padx=5, pady=5)
        Label(mainFrame, text='D2').grid(
            row=1, column=3, sticky=W, padx=5, pady=5)
        Label(mainFrame, text='E2').grid(
            row=1, column=4, sticky=W, padx=5, pady=5)
        Label(mainFrame, text='F2').grid(
